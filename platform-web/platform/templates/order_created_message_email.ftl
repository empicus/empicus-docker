	...
	<head>
		...
		<style type="text/css">
			...
			*/
			...
			.invoiceContent { padding: 10px !important; }
			...
			@media only screen and (max-width: 480px){
				...
				desktop.
				*/
/* 				td[class="textContent"], td[class="flexibleContainerCell"] { width: 100%; padding: 10px !important; padding-right: 10px !important; }
																			...
																			<tr>
																				<td align="left" class="textContent">
																					<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																						You order has been successfully created.
																					</div>
																				</td>
																			</tr>
																		</table>
						...
						<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
							...
							<tr>
								<td align="center" valign="top">
									...
									-->
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#fb8122">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<!--
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Thank you for your order</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">Invoice #: ${academicOrder.code}</h2>
															...
															<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
																<tr>
																	<td align="left" valign="top" class="flexibleContainerBox">
																		<table border="1" cellpadding="0" cellspacing="0" width="90%" style="max-width: 100%;">
																			<tr>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px"><b>Title</b></td>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px">${academicOrder.title}</td>
																			</tr>
																			<tr>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px"><b>Type</b></td>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px">${academicDocTypeItem}</td>
																			</tr>
																			<tr>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px"><b>Level</b></td>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px">${academicLevelItem}</td>
																			</tr>
																			<tr>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px"><b>Pages</b></td>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px">${academicOrder.pageCount}</td>
																			</tr>
																			<tr>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px"><b>Due Date</b></td>
																				<td align="left" class="textContent invoiceContent"  style="padding: 10px">${dueDt}</td>
																			</tr>
																		</table>
																	</td>
																	<!-- <td align="right" valign="middle" class="flexibleContainerBox">
																...
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" 
																			href="https://www.brainboxessays.com/dist/client-home-ng/portal-academic/view-academic-order/${academicOrder.code}" target="_blank">Confirmation</a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
